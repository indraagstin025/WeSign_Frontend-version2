      ...
      <div className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 sm:px-6 shadow-sm shrink-0">
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="truncate text-left">
              ...
              {state.doc && (
                <p className="text-[10px] text-slate-500 dark:text-slate-500 font-bold uppercase tracking-widest">{state.doc.type || 'General Document'}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            disabled={!state.url}
            className="p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 dark:text-slate-400 transition-all border-none bg-transparent cursor-pointer disabled:opacity-30"
