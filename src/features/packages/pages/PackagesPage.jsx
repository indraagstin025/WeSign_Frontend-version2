        ...
        <div className="flex flex-col h-screen lg:h-[calc(100vh-4rem)] max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 overflow-hidden">
            ...
            <div className="flex-shrink-0 animate-in fade-in duration-700">
                ...
                <div className="hidden lg:flex items-center px-6 py-4 mt-6 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#0B1120] transition-colors rounded-t-2xl shadow-[0_1px_0_0_rgba(0,0,0,0.05)]">
                   <div className="w-[5%] text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest pl-2">No.</div>
                   <div className="w-[36%] text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Nama Paket</div>
                   <div className="w-[15%] text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">Kategori</div>
                   <div className="w-[15%] text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">Status</div>
                   <div className="w-[15%] text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">Dokumen</div>
                   <div className="w-[14%] text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-right pr-6">Aksi</div>
                </div>
            </div>
                ...
                {loading ? (
                    <div className="h-full flex flex-col items-center justify-center p-12 space-y-5">
                        ...
                        <div className="text-center animate-pulse">
                            <p className="text-sm font-bold text-slate-800 dark:text-slate-200 tracking-wider uppercase">Memproses Paket</p>
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Mengambil data arsip Anda...</p>
                        </div>
                    </div>
                ) : error ? (
                    <div className="h-full flex flex-col items-center justify-center p-12 space-y-6 text-center">
                        ...
                        <button 
                            ...
                            className="px-8 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-sm font-bold rounded-2xl border-none cursor-pointer hover:bg-slate-800 transition-all active:scale-95 shadow-lg shadow-slate-900/20 dark:shadow-white/10"
                        >
                            Muat Ulang Halaman
                        </button>
                    </div>
                    ...
                    <div className="h-full flex flex-col items-center justify-center p-12 text-center space-y-8 animate-in fade-in duration-700">
                        <div className="w-28 h-28 bg-slate-50 dark:bg-slate-800/40 rounded-[40px] flex items-center justify-center text-slate-300 dark:text-slate-700 border-2 border-dashed border-slate-200 dark:border-slate-800 shadow-inner">
                            <Layers size={48} />
                        </div>
