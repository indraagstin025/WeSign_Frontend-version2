  ...
  return (
    <div className="fixed inset-0 z-[150] bg-zinc-50 dark:bg-zinc-950 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        {/* PDF Viewer */}
        <main
          className={`flex-1 overflow-y-auto no-scrollbar bg-zinc-100 dark:bg-zinc-950 p-4 sm:p-8 flex items-start justify-center relative select-none pb-44 sm:pb-8 min-w-0
