 ...
 * @description Progress bar dokumen + daftar kolaborator online.
 * Pure presentation — derivasi data di `useGroupSignerProgressData`.
 */
const GroupSignerProgress = ({
  groupData,
  signatures, // unused di hook tapi dipertahankan untuk backward-compat props
  totalSigners,
  pendingSigners,
  documentId,
  activeUsers = [],
